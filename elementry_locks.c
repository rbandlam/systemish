...
main()
{
	...
	int iret1, iret2;
	iret1 = pthread_create( &thread1, NULL, counter_incrementer_function, NULL);
	// Move the pthread_join here to do sequential execution
	iret2 = pthread_create( &thread2, NULL, counter_incrementer_function, NULL);
